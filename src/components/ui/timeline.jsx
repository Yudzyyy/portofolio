...
export const Timeline = ({ data, className }) => {
  ...
  return (
    <div
      className={cn(
        // ubah bg-black -> bg-transparent agar partikel kelihatan
        "w-full bg-transparent text-white font-sans md:px-10",
        className
      )}
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-neutral-400 text-sm md:text-base max-w-sm">
          A summary of my professional and organizational journey.
        </p>
      </div>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-black/70 flex items-center justify-center">
